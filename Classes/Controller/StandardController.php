...
use Wwwision\Neos\GraphQl\Types\RootTypes\Mutation;
use Wwwision\Neos\GraphQl\Types\RootTypes\Query;
...
class StandardController extends ActionController
{
    ...
    {
        $schema = new Schema($this->typeResolver->get(Query::class), $this->typeResolver->get(Mutation::class));
